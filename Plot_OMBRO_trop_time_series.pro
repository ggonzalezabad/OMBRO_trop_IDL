restore, 'Poopo_time_series_0p2x0p2_SZA70_XT4-56_CF30_global.sav'
...
mask = WHERE(YEAR GE 2005 AND MONTH GE 1)
;; mask_modis = WHERE(modis_date_jul GT 0)

OPEN_DEVICE, /PS, /Color, $
             filename='Poopo_time_series_0p2x0p2_SZA70_XT4-56_CF30.ps'
!P.Multi = [0,1,3]
...
cgplot, date_jul[mask], Aral_final_data[1,mask], color = 1,                  $
        ...
        xtickunits = 'Years', CHARSIZE = 1.7
cgplot, date_jul[mask], Aral_final_data[1,mask], color = 1, /overplot
...
cgplot, date_jul[mask], Aral_final_data[6,mask], $
        ...
        xtickunits = 'Years', CHARSIZE = 1.7
cgplot, date_jul[mask], Aral_final_data[6,mask], color = 1, /overplot
;; cgaxis, YAxis = 1, yrange = [0.05,0.15], color = 1, /save
;; cgplot, modis_date_jul[mask_modis], aral_avg[mask_modis], color = 3, /Overplot
